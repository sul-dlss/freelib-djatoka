$(document).ready(
    function() {
      ...
      socket.onopen = function() {
        // Open the log we've set as our 'active' log (in this case, the
        // default)
        openNewLog();
      ...
      if (!Date.prototype.toISOString) {
        // Here we rely on JSON serialization for dates because it
        // matches
        // the ISO standard. However, we check if JSON serializer is
        // present
