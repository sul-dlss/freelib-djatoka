...
public class IIIFException extends Exception {
     ...
     */
    public IIIFException(final String aMessage) {
        super(aMessage);
    }
     ...
     */
    public IIIFException(final Exception aException) {
        super(aException);
    }
     ...
     * @param aException The exception that was the cause of this exception
     */
    public IIIFException(final String aMessage, final Exception aException) {
