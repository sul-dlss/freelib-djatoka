...
public class CacheUtilsTest {
    ...
    public void testGetCachingQueries() {
        ...
        String[] expected =
                new String[] {
                    "/all/1", "/all/2", "/all/4", "/all/8", "/all/16",
                    "/all/32", "/all/64", "/all/128", "/all/256",
                    "/0,0,2047,2047/512", "/2048,0,2048,2047/512",
    ...
    public void testGetRegion() {
        assertEquals("0,0,1023,1023", CacheUtils
                .getRegion(10, 1684, 2338, 0, 0));
    }
